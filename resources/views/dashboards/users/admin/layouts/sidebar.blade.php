<aside class="layout-menu menu-vertical menu bg-menu-theme" id="layout-menu">
    <div class="app-brand demo">
      <a class="app-brand-link" href="{{URL::to('/')}}">
        ...
        <span class="app-brand-text menu-text fw-bold">
            @if($user->role == 'admin')
                پیشخوان مدیر
            @elseif($user->role == 'senior_support')
                پشتیبان ارشد    
            @elseif($user->role == 'support_level_one')
                پشتیبان سطح یک
    ...
    <ul class="admin-dashboard menu-inner py-1">
        ...
        @can('banners_index')
            ...
            {{Route::currentRouteName() == 'admin.dashboard.dynamic-banners.psite-slider-one-banner.index' ? 'active open' : ''}}
            {{Route::currentRouteName() == 'admin.dashboard.dynamic-banners.project-slider-one-banner.index' ? 'active open' : ''}}
            " style="">
                <a class="menu-link menu-toggle" href="javascript:void(0);">
                ...
                <ul class="menu-sub">
                    ...
                    {{Route::currentRouteName() == 'admin.dashboard.dynamic-banners.psite-slider-one-banner.index' ? 'active open' : ''}}
                    " style="">
                        <a class="menu-link" href="{{route('admin.dashboard.dynamic-banners.psite-slider-one-banner.index')}}">
                            <div>
                                اسلایدر صفحه کسب و کار
                            </div>
                        </a>
                    </li>
                    <li class="menu-item 
                    {{Route::currentRouteName() == 'admin.dashboard.dynamic-banners.project-slider-one-banner.index' ? 'active open' : ''}}
                    " style="">
                        <a class="menu-link" href="{{route('admin.dashboard.dynamic-banners.project-slider-one-banner.index')}}">
                            <div>
                                اسلایدر صفحه پروژه
                            </div>
                        </a>
        ...
        @if(auth()->user()->can('magazine_category_index') || auth()->user()->can('magazine_post_index'))
        ...
        @if(auth()->user()->can('ads_index') || auth()->user()->can('psite_index') || auth()->user()->can('project_index'))
            ...
            " style="">
                ...
                @if(auth()->user()->can('project_index'))
                    <ul class="menu-sub">
                        <li class="menu-item
                        {{Route::currentRouteName() == 'admin.dashboard.users-activities.project.verified.index' ? 'active open' : ''}}
                        {{Route::currentRouteName() == 'admin.dashboard.users-activities.project.verified.edit' ? 'active open' : ''}}
        ...
        @can('visits_index')
            ...
            <li class="menu-item
                ...
                {{Route::currentRouteName() == 'admin.dashboard.visits.chart.iran.index' ? 'active open' : ''}}
                {{Route::currentRouteName() == 'admin.dashboard.visits.chart.global.index' ? 'active open' : ''}}
            " style="">
                <a class="menu-link menu-toggle" href="javascript:void(0);">
                ...
                <ul class="menu-sub">
                    ...
                    " style="">              
                        ...
                        <ul class="menu-sub">
                            ...
                            {{Route::currentRouteName() == 'admin.dashboard.visits.chart.iran.index' ? 'active open' : ''}}
                            ">
                                <a class="menu-link" href="{{route('admin.dashboard.visits.chart.iran.index')}}">
                                    <div>
                                        نمودار ایران
                                    </div>
                                </a>
                            ...
                            {{Route::currentRouteName() == 'admin.dashboard.visits.chart.global.index' ? 'active open' : ''}}
                            ">
                                <a class="menu-link" href="{{route('admin.dashboard.visits.chart.global.index')}}">
                                    <div>
                                        نمودار جهان
                                    </div>
                                </a>
        ...
        @can('permissions_index')
            <!-- Beginnig of Permissions Section -->
            {{-- <li class="menu-header small text-uppercase">
                <span class="menu-header-text">
                    مجوز ها
                </span>
            ...
            <li class="menu-item
                {{Route::currentRouteName() == 'admin.dashboard.permissions.index' ? 'active open' : ''}}
            " style="">
                <a class="menu-link menu-toggle" href="javascript:void(0);">
                ...
                <ul class="menu-sub">
                    <li class="menu-item 
                        {{Route::currentRouteName() == 'admin.dashboard.permissions.index' ? 'active open' : ''}}
                    " style="">
                        <a class="menu-link" href="{{route('admin.dashboard.permissions.index')}}">
                            <div>
                                تعیین سطح دسترسی
                            </div>
                        </a>
