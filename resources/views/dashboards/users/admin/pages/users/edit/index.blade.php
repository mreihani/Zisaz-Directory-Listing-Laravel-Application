...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="app-magazine">
            <form action="{{route('admin.dashboard.user.update', $selectedUser)}}" method="POST" novalidate>
                @method('PUT')
                @csrf
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
                    <div class="d-flex flex-column justify-content-center">
                        <h4 class="mb-1 mt-3">اطلاعات کاربر را بروزرسانی کنید</h4>
                        <p class="text-muted">
                            کاربر می تواند در سامانه فعالیت نماید
                        </p>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input autofocus class="form-control" id="firstname" name="firstname" type="text" placeholder="نام کاربر را وارد نمایید" value="{{old('firstname', $selectedUser->firstname)}}" />
                                @error("firstname")
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <span class="text-danger">*</span>
                                <input class="form-control" id="lastname" name="lastname" type="text" placeholder="نام خانوادگی کاربر را وارد نمایید" value="{{old('lastname', $selectedUser->lastname)}}" />
                                @error("lastname")
                                    <span class="text-danger">
                                        {{ $message }}
                                    </span>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    <input class="form-control ltr" id="phoneNumber" name="phone" placeholder="0910 000 0000" type="text" value="{{old('phone', $selectedUser->phone)}}" />
                                </div>
                                @error("phone")
                                    <span class="text-danger">
                                        {{ $message }}
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" id="email" name="email" placeholder="email@example.com" type="email" value="{{old('email', $selectedUser->email)}}" />
                                @error("email")
                                    <span class="text-danger">
                                        {{ $message }}
                                    </span>
