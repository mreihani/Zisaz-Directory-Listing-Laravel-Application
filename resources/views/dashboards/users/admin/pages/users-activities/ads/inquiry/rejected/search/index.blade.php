            ...
            <div class="card-header flex-column flex-md-row">
                ...
                <div class="row">
                    <div class="col-md-5 d-flex justify-content-start">
                        <form method="GET" action="{{route('admin.dashboard.users-activities.ads.inquiry.rejected.search')}}">
                    ...
                    <div class="col-md-7 d-flex justify-content-md-end">
                        <a href="{{route('admin.dashboard.users-activities.ads.inquiry.rejected.index')}}" class="text-white btn btn-primary waves-effect waves-light">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('activity', $activityItem->slug)}}">
                                                {{$activityItem->inquiry->item_title}}
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            @if($activityItem->inquiry->type == 'inquiry_buy')
                                                <span class="badge rounded-pill bg-label-primary">
                                                    خرید
                                                </span>
                                            @elseif($activityItem->inquiry->type == 'inquiry_project')
                                        ...
                                        <td class="d-flex align-items-center">
                                            @can('ads_destroy')
                                                <form action="{{route('admin.dashboard.users-activities.ads.inquiry.rejected.destroy', $activityItem->id)}}" method="POST">
                                                    @method('delete')
                                                    @csrf
