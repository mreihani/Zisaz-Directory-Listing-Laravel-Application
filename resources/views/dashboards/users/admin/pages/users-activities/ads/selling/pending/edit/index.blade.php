...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="magazine">
            <form action="{{route('admin.dashboard.users-activities.ads.selling.pending.update', $activity->id)}}" method="POST">
                @method('PUT')
                @csrf
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
                    ...
                    <div class="d-flex align-content-center flex-wrap gap-3">
                        <div class="d-flex gap-3">
                            <a class="btn btn-label-secondary" href="{{route('admin.dashboard.users-activities.ads.selling.pending.index')}}">
                                بازگشت
                            </a>
                        </div>
