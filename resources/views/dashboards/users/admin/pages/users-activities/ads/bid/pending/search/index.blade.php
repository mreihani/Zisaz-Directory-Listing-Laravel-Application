            ...
            <div class="card-header flex-column flex-md-row">
                ...
                <div class="row">
                    <div class="col-md-5 d-flex justify-content-start">
                        <form method="GET" action="{{route('admin.dashboard.users-activities.ads.bid.pending.search')}}">
                    ...
                    <div class="col-md-7 d-flex justify-content-md-end">
                        <a href="{{route('admin.dashboard.users-activities.ads.bid.pending.index')}}" class="text-white btn btn-primary waves-effect waves-light">
                            ...
                            <tbody>
                                @foreach ($activities as $activityKey => $activityItem)
                                    <tr>
                                        ...
                                        <td>
                                            @if($activityItem->bid->type == 'auction')
                                                <span class="badge rounded-pill bg-label-primary">
                                                    مزایده
                                                </span>
                                            @elseif($activityItem->bid->type == 'tender_buy')
                                                <span class="badge rounded-pill bg-label-success">
                                                    مناقصه خرید
                                                </span>
                                            @elseif($activityItem->bid->type == 'tender_project')
                                        ...
                                        <td class="d-flex align-items-center">
                                            <form action="{{route('admin.dashboard.users-activities.ads.bid.pending.destroy', $activityItem->id)}}" method="POST">
                                                @method('delete')
                                                @csrf
                                            ...
                                            <a href="{{route('admin.dashboard.users-activities.ads.bid.pending.edit', $activityItem->id)}}" class="btn btn-sm btn-icon item-edit">
