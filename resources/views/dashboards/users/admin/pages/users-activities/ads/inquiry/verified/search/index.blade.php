            ...
            <div class="card-header flex-column flex-md-row">
                ...
                <div class="row">
                    <div class="col-md-5 d-flex justify-content-start">
                        <form method="GET" action="{{route('admin.dashboard.users-activities.ads.inquiry.verified.search')}}">
                    ...
                    <div class="col-md-7 d-flex justify-content-md-end">
                        <a href="{{route('admin.dashboard.users-activities.ads.inquiry.verified.index')}}" class="text-white btn btn-primary waves-effect waves-light">
                                ...
                                @foreach ($activities as $activityKey => $activityItem)
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <form action="{{route('admin.dashboard.users-activities.ads.inquiry.verified.destroy', $activityItem->id)}}" method="POST">
                                                @method('delete')
                                                @csrf
