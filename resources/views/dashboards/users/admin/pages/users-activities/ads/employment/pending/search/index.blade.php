            ...
            <div class="card-header flex-column flex-md-row">
                ...
                <div class="row">
                    <div class="col-md-5 d-flex justify-content-start">
                        <form method="GET" action="{{route('admin.dashboard.users-activities.ads.employment.pending.search')}}">
                    ...
                    <div class="col-md-7 d-flex justify-content-md-end">
                        <a href="{{route('admin.dashboard.users-activities.ads.employment.pending.index')}}" class="text-white btn btn-primary waves-effect waves-light">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('activity', $activityItem->slug)}}">
                                                {{$activityItem->employment->item_title}}
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            @if($activityItem->employment->type == 'employee')
                                                <span class="badge rounded-pill bg-label-primary">
                                                    کارجو
                                                </span>
                                            @elseif($activityItem->employment->type == 'employer')
                                        ...
                                        <td class="d-flex align-items-center">
                                            <form action="{{route('admin.dashboard.users-activities.ads.employment.pending.destroy', $activityItem->id)}}" method="POST">
                                                @method('delete')
                                                @csrf
                                            ...
                                            <a href="{{route('admin.dashboard.users-activities.ads.employment.pending.edit', $activityItem->id)}}" class="btn btn-sm btn-icon item-edit">
