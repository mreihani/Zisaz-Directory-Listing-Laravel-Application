...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="magazine">
            <form action="{{route('admin.dashboard.users-activities.ads.employment.pending.update', $activity->id)}}" method="POST">
                @method('PUT')
                @csrf
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-5 pb-5">
                    ...
                    <div class="d-flex align-content-center flex-wrap gap-3">
                        <div class="d-flex gap-3">
                            <a class="btn btn-label-secondary" href="{{route('admin.dashboard.users-activities.ads.employment.pending.index')}}">
                                بازگشت
                            </a>
                        </div>
                ...
                <!-- Page content-->
                @if($activity->subactivity->type == 'employee')
