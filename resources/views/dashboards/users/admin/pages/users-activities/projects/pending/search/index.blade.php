    ...
    <div class="content-wrapper">
        <div class="card">
            ...
            <h5 class="card-header">
                جستجوی کسب و کار های در حال بررسی
            </h5>
            ...
            <div class="card-header flex-column flex-md-row">
                ...
                <div class="row">
                    <div class="col-md-5 d-flex justify-content-start">
                        <form method="GET" action="{{route('admin.dashboard.users-activities.project.pending.search')}}">
                    ...
                    <div class="col-md-7 d-flex justify-content-md-end">
                        <a href="{{route('admin.dashboard.users-activities.project.pending.index')}}" class="text-white btn btn-primary waves-effect waves-light">
                ...
                <div class="row dt-row">
                    <div class="col-sm-12">
                        <table class="datatables-direct-basic table">
                            ...
                            <tbody>
                                @foreach ($projects as $projectKey => $projectItem)
                                    <tr>
                                        <td>
                                            <bdi>
                                                {{ ($projects->currentPage() - 1) * $projects->perPage() + $projectKey + 1 }}
                                            </bdi>
                                        </td>
                                        <td>
                                            <a href="{{route('project', $projectItem->slug)}}">
                                                {{$projectItem->projectInfo->title}}
                                            </a>
                                        </td>
                                        <td>
                                            {{$projectItem->user->firstname}}
                                            {{$projectItem->user->lastname}}
                                        </td>
                                        <td class="d-flex align-items-center">
                                            <form action="{{route('admin.dashboard.users-activities.project.pending.destroy', $projectItem->id)}}" method="POST">
                                                @method('delete')
                                                @csrf
                                            ...
                                            <a href="{{route('admin.dashboard.users-activities.project.pending.edit', $projectItem->id)}}" class="btn btn-sm btn-icon item-edit">
                ...
                <div class="row mt-3">
                    <div class="col-md-12 d-flex justify-content-center">
                        <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate">
                            {{$projects->links('vendor.pagination.dashboards-datatables')}}
                        </div>
                    </div>
                </div>
