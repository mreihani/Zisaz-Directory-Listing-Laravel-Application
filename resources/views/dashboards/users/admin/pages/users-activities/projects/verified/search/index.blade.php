            ...
            <div class="card-header flex-column flex-md-row">
                ...
                <div class="row">
                    <div class="col-md-5 d-flex justify-content-start">
                        <form method="GET" action="{{route('admin.dashboard.users-activities.project.verified.search')}}">
                    ...
                    <div class="col-md-7 d-flex justify-content-md-end">
                        <a href="{{route('admin.dashboard.users-activities.project.verified.index')}}" class="text-white btn btn-primary waves-effect waves-light">
                            ...
                            <tbody>
                                @foreach ($projects as $projectKey => $projectItem)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('site', $projectItem->slug)}}">
                                        ...
                                        <td class="d-flex align-items-center">
                                            <form action="{{route('admin.dashboard.users-activities.project.verified.destroy', $projectItem->id)}}" method="POST">
                                                @method('delete')
                                                @csrf
