            ...
            <div class="card-header flex-column flex-md-row">
                ...
                <div class="row">
                    <div class="col-md-5 d-flex justify-content-start">
                        <form method="GET" action="{{route('admin.dashboard.users-activities.private-website.pending.search')}}">
                    ...
                    <div class="col-md-7 d-flex justify-content-md-end">
                        <a href="{{route('admin.dashboard.users-activities.private-website.pending.index')}}" class="text-white btn btn-primary waves-effect waves-light">
                            <i class="ti ti-arrow-back me-sm-1"></i> 
                            بازگشت به لیست کسب و کار ها
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="row dt-row">
                    <div class="col-sm-12">
                        <table class="datatables-direct-basic table">
                            ...
                            <tbody>
                                @foreach ($psites as $psiteKey => $psiteItem)
                                    <tr>
                                        <td>
                                            <bdi>
                                                {{ ($psites->currentPage() - 1) * $psites->perPage() + $psiteKey + 1 }}
                                            </bdi>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            {{$psiteItem->user->lastname}}
                                        </td>
                                        <td class="d-flex align-items-center">
                                            <form action="{{route('admin.dashboard.users-activities.private-website.pending.destroy', $psiteItem->id)}}" method="POST">
                                                @method('delete')
                                                @csrf
                                            ...
                                            <a href="{{route('admin.dashboard.users-activities.private-website.pending.edit', $psiteItem->id)}}" class="btn btn-sm btn-icon item-edit">
                ...
                <div class="row mt-3">
                    <div class="col-md-12 d-flex justify-content-center">
                        <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate">
                            {{$psites->links('vendor.pagination.dashboards-datatables')}}
                        </div>
                    </div>
                </div>
