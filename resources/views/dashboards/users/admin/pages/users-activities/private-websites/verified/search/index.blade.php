    ...
    <div class="content-wrapper">
        <div class="card">
            ...
            <h5 class="card-header">
                جستجوی کسب و کار های تأیید شده
            </h5>
            ...
            <div class="card-header flex-column flex-md-row">
                ...
                <div class="row">
                    <div class="col-md-5 d-flex justify-content-start">
                        <form method="GET" action="{{route('admin.dashboard.users-activities.private-website.verified.search')}}">
                    ...
                    <div class="col-md-7 d-flex justify-content-md-end">
                        <a href="{{route('admin.dashboard.users-activities.private-website.verified.index')}}" class="text-white btn btn-primary waves-effect waves-light">
                                ...
                                @foreach ($psites as $psiteKey => $psiteItem)
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <form action="{{route('admin.dashboard.users-activities.private-website.verified.destroy', $psiteItem->id)}}" method="POST">
                                                @method('delete')
                                                @csrf
