            ...
            <div class="card-header flex-column flex-md-row">
                ...
                <div class="row">
                    <div class="col-md-5 d-flex justify-content-start">
                        <form method="GET" action="{{route('admin.dashboard.magazine.category.search')}}">
                    ...
                    @can('magazine_category_create')
                        <div class="col-md-7 d-flex justify-content-md-end">
                            <a href="{{route('admin.dashboard.magazine.category.create')}}" class="text-white btn btn-primary waves-effect waves-light">
                                افزودن دسته بندی
                            </a>
                        </div>
                    @endcan
                ...
                <div class="row dt-row">
                    <div class="col-sm-12">
                        <table class="datatables-direct-basic table">
                            ...
                            <tbody>
                                @foreach ($magCategories as $magCategoryKey => $magCategoryItem)
                                    <tr>
                                        <td>
                                            <bdi>
                                                {{ ($magCategories->currentPage() - 1) * $magCategories->perPage() + $magCategoryKey + 1 }}
                                            </bdi>
                                        </td>
                                        <td>
                ...
                <div class="row mt-3">
                    <div class="col-md-12 d-flex justify-content-center">
                        <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate">
                            {{$magCategories->links('vendor.pagination.dashboards-datatables')}}
                        </div>
                    </div>
                </div>
