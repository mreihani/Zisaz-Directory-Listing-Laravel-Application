...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="magazine">
            <form action="{{route('admin.dashboard.magazine.category.store')}}" method="POST">
                @csrf
                <!-- Add Blog Category -->
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
                    <div class="d-flex flex-column justify-content-center">
                        <h4 class="mb-1 mt-3">یک دسته بندی جدید اضافه کنید</h4>
                        <p class="text-muted">
                    ...
                    <div class="d-flex align-content-center flex-wrap gap-3">
                        ...
                        <button class="btn btn-primary" type="submit">انتشار دسته بندی</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control mb-2" id="zisaz-magazine-category-name" name="title" value="{{old('title')}}" placeholder="عنوان دسته بندی مقاله را وارد نمایید" type="text"/>
                                    @error("title")
