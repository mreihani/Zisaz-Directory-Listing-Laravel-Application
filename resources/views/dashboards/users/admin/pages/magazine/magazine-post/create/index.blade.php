...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="app-magazine">
            <form action="{{route('admin.dashboard.magazine.post.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
                    <div class="d-flex flex-column justify-content-center">
                        <h4 class="mb-1 mt-3">یک مقاله جدید اضافه کنید</h4>
                    ...
                    <div class="d-flex align-content-center flex-wrap gap-3">
                        ...
                        <button class="btn btn-primary" type="submit">انتشار مقاله</button>
                    </div>
                </div>
                <div class="row">
                    <!-- First column-->
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input aria-label="عنوان مقاله" class="form-control" id="magazine-post-title" name="title" placeholder="عنوان مقاله را وارد نمایید" type="text" value="{{old('title')}}" />
                                    @error("title")
                                ...
                                <div class="mb-3">
                                    ...
                                    <span class="text-danger">*</span>
                                    <input aria-label="اسلاگ مقاله" class="form-control" id="magazine-post-slug" name="slug" placeholder="اسلاگ مقاله را وارد نمایید" type="text" value="{{old('slug')}}" />
                                    @error("slug")
                                        <span class="text-danger">
                                            {{ $message }}
                                        </span>
                                ...
                                <div>
                                    ...
                                    @enderror
                                    <textarea id="zisaz-magazine-post-editor" name="body">{{old('body')}}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <span class="text-danger">*</span>
                                    <input aria-label="عنوان متا" class="form-control" id="magazine-meta-title" name="meta_title" placeholder="عنوان متا را وارد نمایید" type="text" value="{{old('meta_title')}}" />
                                    @error("meta_title")
                                        <span class="text-danger">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <span class="text-danger">*</span>
                                    <textarea class="form-control" id="magazine-meta-description" name="meta_description" rows="3" placeholder="توضیحات متای مربوط به سئوی مقاله را وارد نمایید">{{old('meta_description')}}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input aria-label="کلمات کلیدی" class="form-control" id="magazine-meta-keywords" name="meta_keywords" placeholder="صنعت ساختمان، پیمانکار، میلگرد، بتن، قرارداد مشارکت در ساخت" type="text" value="{{old('meta_keywords')}}"/>
                                    @error("meta_keywords")
                                        <span class="text-danger">
                                            {{ $message }}
                                        </span>
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body d-flex justify-content-center">
                                ...
                                <img src="#" alt="تصویر مقاله را انتخاب نمایید" id="file-preview" class="dropzone needsclick dz-clickable text-center" onerror="this.src='{{asset('assets/dashboards/assets/img/jaban/image-up.svg')}}'">
                            </div>
                        </div>
                        <!-- /Media -->
                                    ...
                                    @if($magCategories->count())
                                        <select class="select2 form-select" data-placeholder="انتخاب دسته" id="magazine-category-selection" name="mag_category_id">
                                            ...
                                            @foreach ($magCategories as $magCategoryItem)
                                                <option value="{{$magCategoryItem->id}}">
