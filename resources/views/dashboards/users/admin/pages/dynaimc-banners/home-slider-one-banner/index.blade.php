    ...
    <div class="content-wrapper">
        <div class="card">
            ...
            <h5 class="card-header">
                تنظیمات اسلایدر یک در صفحه اصلی
            </h5>

            <div class="card-header flex-column flex-md-row">

                <form action="{{route('admin.dashboard.dynamic-banners.home-slider-one-banner.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-check form-switch mb-3">
                                <input {{($homeFirstSliderSlideOne && $homeFirstSliderSlideOne->display_banner == 1) ? 'checked' : ''}} class="form-check-input" id="showBannerSwitch" type="checkbox" name="display_banner">
                        ...
                        <div class="row">   
                            <div class="col-md-6">
                                <label class="form-label" for="slide-image-one">
                                    ...
                                    (ابعاد تصویر باید 1119x631 پیکسل باشد)
                                </label>
                                ...
                                <div class="mt-3">
                                    ...
                                    <input class="form-control" id="slide-one" type="text" name="slider_url_one" value="{{old('slider_url_one', $homeFirstSliderSlideOne ? $homeFirstSliderSlideOne->url : '')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                @if($homeFirstSliderSlideOne)
                                    <div class="d-flex justify-content-center mt-4">
                                        <img class="d-block rounded-3" style="max-width: -webkit-fill-available;" src="{{asset($homeFirstSliderSlideOne->image)}}" alt="">
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row">   
                            <div class="col-md-6">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input class="form-control" id="slide-two" type="text" name="slider_url_two" value="{{old('slider_url_two', $homeFirstSliderSlideTwo ? $homeFirstSliderSlideTwo->url : '')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                @if($homeFirstSliderSlideTwo)
                                    <div class="d-flex justify-content-center mt-4">
                                        <img class="d-block rounded-3" style="max-width: -webkit-fill-available;" src="{{asset($homeFirstSliderSlideTwo->image)}}" alt="">
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row">   
                            <div class="col-md-6">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input class="form-control" id="slide-three" type="text" name="slider_url_three" value="{{old('slider_url_three', $homeFirstSliderSlideThree ? $homeFirstSliderSlideThree->url : '')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                @if($homeFirstSliderSlideThree)
                                    <div class="d-flex justify-content-center mt-4">
                                        <img class="d-block rounded-3" style="max-width: -webkit-fill-available;" src="{{asset($homeFirstSliderSlideThree->image)}}" alt="">
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row">   
                            <div class="col-md-6">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input class="form-control" id="slide-four" type="text" name="slider_url_four" value="{{old('slider_url_four', $homeFirstSliderSlideFour ? $homeFirstSliderSlideFour->url : '')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                @if($homeFirstSliderSlideFour)
                                    <div class="d-flex justify-content-center mt-4">
                                        <img class="d-block rounded-3" style="max-width: -webkit-fill-available;" src="{{asset($homeFirstSliderSlideFour->image)}}" alt="">
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row">   
                            <div class="col-md-6">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input class="form-control" id="slide-five" type="text" name="slider_url_five" value="{{old('slider_url_five', $homeFirstSliderSlideFive ? $homeFirstSliderSlideFive->url : '')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                @if($homeFirstSliderSlideFive)
                                    <div class="d-flex justify-content-center mt-4">
                                        <img class="d-block rounded-3" style="max-width: -webkit-fill-available;" src="{{asset($homeFirstSliderSlideFive->image)}}" alt="">
                                    </div>
                                @endif
                            </div>
                        </div>
