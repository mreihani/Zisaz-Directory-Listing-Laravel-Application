    ...
    <div class="content-wrapper">
        <div class="card">
            ...
            <h5 class="card-header">
                تنظیمات اسلایدر یک در صفحه پروژه
            </h5>

            <div class="card-header flex-column flex-md-row">

                <form action="{{route('admin.dashboard.dynamic-banners.project-slider-one-banner.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-check form-switch mb-3">
                                <input {{($projectFirstSliderSlideOne && $projectFirstSliderSlideOne->display_banner == 1) ? 'checked' : ''}} class="form-check-input" id="showBannerSwitch" type="checkbox" name="display_banner">
                        ...
                        <div class="row">   
                            <div class="col-md-6">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input class="form-control" id="slide-one" type="text" name="slider_url_one" value="{{old('slider_url_one', $projectFirstSliderSlideOne ? $projectFirstSliderSlideOne->url : '')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                @if($projectFirstSliderSlideOne)
                                    <div class="d-flex justify-content-center mt-4">
                                        <img class="d-block rounded-3" style="max-width: -webkit-fill-available;" src="{{asset($projectFirstSliderSlideOne->image)}}" alt="">
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row">   
                            <div class="col-md-6">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input class="form-control" id="slide-two" type="text" name="slider_url_two" value="{{old('slider_url_two', $projectFirstSliderSlideTwo ? $projectFirstSliderSlideTwo->url : '')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                @if($projectFirstSliderSlideTwo)
                                    <div class="d-flex justify-content-center mt-4">
                                        <img class="d-block rounded-3" style="max-width: -webkit-fill-available;" src="{{asset($projectFirstSliderSlideTwo->image)}}" alt="">
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row">   
                            <div class="col-md-6">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input class="form-control" id="slide-three" type="text" name="slider_url_three" value="{{old('slider_url_three', $projectFirstSliderSlideThree ? $projectFirstSliderSlideThree->url : '')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                @if($projectFirstSliderSlideThree)
                                    <div class="d-flex justify-content-center mt-4">
                                        <img class="d-block rounded-3" style="max-width: -webkit-fill-available;" src="{{asset($projectFirstSliderSlideThree->image)}}" alt="">
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row">   
                            <div class="col-md-6">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input class="form-control" id="slide-four" type="text" name="slider_url_four" value="{{old('slider_url_four', $projectFirstSliderSlideFour ? $projectFirstSliderSlideFour->url : '')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                @if($projectFirstSliderSlideFour)
                                    <div class="d-flex justify-content-center mt-4">
                                        <img class="d-block rounded-3" style="max-width: -webkit-fill-available;" src="{{asset($projectFirstSliderSlideFour->image)}}" alt="">
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row">   
                            <div class="col-md-6">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input class="form-control" id="slide-five" type="text" name="slider_url_five" value="{{old('slider_url_five', $projectFirstSliderSlideFive ? $projectFirstSliderSlideFive->url : '')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                @if($projectFirstSliderSlideFive)
                                    <div class="d-flex justify-content-center mt-4">
                                        <img class="d-block rounded-3" style="max-width: -webkit-fill-available;" src="{{asset($projectFirstSliderSlideFive->image)}}" alt="">
                                    </div>
                                @endif
                            </div>
                        </div>
