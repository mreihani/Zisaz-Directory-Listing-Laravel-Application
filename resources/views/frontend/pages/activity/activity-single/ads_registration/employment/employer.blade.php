        ...
        <div class="row">
            ...
            <div class="col-lg-7 position-relative pe-lg-5 mb-5 mb-lg-0" style="z-index: 1025;">
                ...
                @if($activity->academic->count())
                    ...
                    <ul class="list-unstyled">
                        @foreach ($activity->academic as $academicItem)
                            <li class="d-flex">
                                <span class="text-primary fs-lg me-2">•</span>
                                {{$academicItem->title}}
                            </li> 
                ...
                @if($activity->gender->count())
                    ...
                    <ul class="list-unstyled">
                        @foreach ($activity->gender as $genderItem)
                            <li class="d-flex">
                                <span class="text-primary fs-lg me-2">•</span>
                                {{$genderItem->title}}
                            </li> 
                ...
                @foreach($similarItems as $similarItem)
                    ...
                    <div class="pb-4">
                        <div class="card bg-secondary card-hover h-100">
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-end border-0 pt-0">
