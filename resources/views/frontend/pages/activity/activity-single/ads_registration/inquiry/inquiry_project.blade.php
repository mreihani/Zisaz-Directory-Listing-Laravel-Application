...
<section class="container mt-5 mb-lg-5 mb-4 pt-5 pb-lg-5">
    ...
    <nav class="mb-3 pt-md-3" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="">آگهی استعلام قیمت</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">استعلام قیمت اجرای پروژه</li>
        </ol>
    </nav>
...
@if($similarItemsCount > 4)
    <section class="container mb-5 pb-2 pb-lg-4">
        <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <a class="btn btn-link fw-normal p-0" href="{{route('get-activities', ['activity_type' => 'ads_registration', 'r_name' => 'inquiry', 'type' => 'tender_project'])}}">
                مشاهده همه
