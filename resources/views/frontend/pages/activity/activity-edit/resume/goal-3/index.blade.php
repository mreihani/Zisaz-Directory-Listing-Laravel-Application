    ...
    <form wire:submit.prevent="save" novalidate>
        ...
        <div class="row mb-4">                          
            <div class="col-sm-12 mb-4">
                ...
                <input disabled="" class="form-control form-control-md" type="text" id="pr-fn" value="معرفی شرکت ساختمانی" placeholder="">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6 mb-4">
                <label class="form-label fw-bold" for="pr-address">نام شرکت</label>
                <span class="text-danger">*</span>
                <input class="form-control form-control-md" type="text" id="pr-address" placeholder="نام شرکت را وارد کنید" wire:model="companyTitle">
            ...
            <div class="col-sm-6 mb-4">
                <label class="form-label fw-bold" for="pr-fn">شماره ثبت</label>
                <span class="text-danger">*</span>
                <input class="form-control form-control-md" type="number" id="pr-fn" placeholder="شماره ثبت شرکت را وارد نمایید" wire:model="companyRegNum">
        ...
        <div class="row">
            <div class="col-12 mb-4">
                <label class="form-label fw-bold" for="pr-address">آدرس دفتر</label>
                <span class="text-danger">*</span>
        ...
        @foreach ($licenseInputs as $licenseKey => $licenseValue)
            @if(count($licenseImage) && isset($licenseImage[$licenseValue]) && is_string($licenseImage[$licenseValue]))
                <div class="row">
                    <div class="col-sm-10">
                        <label class="form-label fw-bold" for="pr-title">مجوزها و افتخارات شرکت را بارگذاری کنید 
                        </label>
                        <span class="fw-bold">(اختیاری)</span>
        ...
        <div class="mb-4">
            <label class="form-label fw-bold" for="pr-description">
                به طور خلاصه درباره پروژه های که توسط شرکت اجرا  شده است بنویسید
            </label>
            <span class="fw-bold">(اختیاری)</span>
