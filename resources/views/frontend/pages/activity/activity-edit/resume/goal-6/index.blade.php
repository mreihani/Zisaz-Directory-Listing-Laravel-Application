    ...
    <form wire:submit.prevent="save" novalidate>
        ...
        <div class="row mb-4">                          
            <div class="col-sm-12 mb-4">
                ...
                <input disabled="" class="form-control form-control-md" type="text" id="pr-fn" value="معرفی کارخانه تولیدی" placeholder="">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6 mb-4">
                <label class="form-label fw-bold" for="pr-address">نام کارخانه / کارگاه</label>
                <span class="text-danger">*</span>
                <input class="form-control form-control-md" type="text" id="pr-address" placeholder="نام کارخانه / کارگاه را وارد کنید" wire:model="companyTitle">
            ...
            <div class="col-sm-6 mb-4">
                ...
                <input class="form-control form-control-md" type="number" id="pr-fn" placeholder="شماره مجوز کارخانه / کارگاه را وارد نمایید" wire:model="companyRegNum">
            </div>
        </div>
            ...
            <div class="col-sm-12 mb-4">
                <div class="mb-2">
                    <label class="form-label fw-bold" for="pr-description">
                        تصویر تابلو یا لوگو کارخانه را بارگذاری نمایید
                    </label>
                    <span class="fw-bold">(اختیاری)</span>
                    <div class="row">
                        <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-12 mb-4">
                <label class="form-label fw-bold" for="pr-address">آدرس کارخانه / کارگاه</label>
                <span class="text-danger">*</span>
            ...
            <div class="col-sm-6 mb-4">
                <label class="form-label fw-bold" for="pr-fn">کد پستی کارخانه / کارگاه </label>
                <span class="fw-bold">(اختیاری)</span>
            ...
            <div class="col-sm-6 mb-4">
                <label class="form-label fw-bold" for="pr-sn">شماره تلفن ثابت کارخانه / کارگاه </label>
                <span class="fw-bold">(اختیاری)</span>
        ...
        @foreach ($licenseInputs as $licenseKey => $licenseValue)
            @if(count($licenseImage) && isset($licenseImage[$licenseValue]) && is_string($licenseImage[$licenseValue]))
                <div class="row">
                    <div class="col-sm-10">
                        <label class="form-label fw-bold" for="pr-title">لطفا پروانه کسب و مجوز های کارخانه / کارگاه را بارگذاری نمایید 
                        </label>
                        <span class="fw-bold">(اختیاری)</span>
        ...
        <!-- Description-->
        <div class="mb-4">
            <label class="form-label fw-bold" for="factory-production-description">
                درباره محصولات تولیدی کارخانه / کارگاه بنویسید.
            </label>
            <span class="fw-bold">(اختیاری)</span>
            <textarea class="form-control" rows="5" id="factory-production-description" placeholder="" wire:model="resumeDescription"></textarea>
        </div>

        <!-- Description-->
        <div class="mb-4">
            <label class="form-label fw-bold" for="factory-projects-description">
                درباره پروژه هایی که توسط کارخانه / کارگاه اجرا شده است بنویسید.
            </label>
            <span class="fw-bold">(اختیاری)</span>
            <textarea class="form-control" rows="5" id="factory-projects-description" placeholder="" wire:model="factoryProjectDescription"></textarea>
        </div>
