    ...
    <form wire:submit.prevent="save" novalidate>
        ...
        <div class="row mb-4">                          
            <div class="col-sm-12 mb-4">
                ...
                <input disabled="" class="form-control form-control-md" type="text" id="pr-fn" value="معرفی تخصص، تجربیات و پروژه های شخصی" placeholder="">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 mb-4">
                <label class="form-label fw-bold" for="pr-fn">کد پستی </label>
                <span class="fw-bold">(اختیاری)</span>
            ...
            <div class="col-sm-6 mb-4">
                <label class="form-label fw-bold" for="pr-sn">شماره تلفن ثابت </label>
                <span class="fw-bold">(اختیاری)</span>
        ...
        <div class="row">
            <div class="col-12 mb-4">
                <label class="form-label fw-bold" for="job-title">عنوان شغل خود را وارد نمایید </label>
                <span class="text-danger">*</span>
                <input class="form-control form-control-md" type="text" id="job-title" placeholder="به عنوان مثال مهندس / مدیر پروژه / استاد کار / کارمند" wire:model="jobTitle">
        ...
        <div class="mb-4">
            <label class="form-label fw-bold" for="pr-description">
                به طور خلاصه درباره مهارت ها و تجربیات خود و پروژه های که اجرا کرده اید بنویسید 
            </label>
            <span class="fw-bold">(اختیاری)</span>
                    ...
                    <div class="border rounded-3 p-3">
                        <div class="row pb-3">
                            <div class="col-sm-12">
                                ...
                                <div class="row row-cols-sm-2 row-cols-md-2 gx-3 gx-lg-3 skills">
                                    @foreach($actGrpsEngArray as $chunkArray)
                                        <div class="col">
                        ...
                        <div class="row pb-3">
                            <div class="col-sm-12">
                                ...
                                <div class="row row-cols-sm-2 row-cols-md-2 gx-3 gx-lg-3 skills">
                                    @foreach($actGrpsManagerArray as $chunkArray)
                                        <div class="col">
                                            @foreach($chunkArray as $chunkItem)
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="act_grps_{{$chunkItem['id']}}"
                        ...
                        <div class="row pb-3">
                            <div class="col-sm-12">
                                ...
                                <div class="row row-cols-sm-2 row-cols-md-2 gx-3 gx-lg-3 skills">
                                    @foreach($actGrpsTechnicalArray as $chunkArray)
                                        <div class="col">
                                            @foreach($chunkArray as $chunkItem)
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="act_grps_{{$chunkItem['id']}}"
