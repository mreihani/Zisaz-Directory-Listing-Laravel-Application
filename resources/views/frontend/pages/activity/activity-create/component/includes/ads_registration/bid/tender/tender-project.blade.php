            ...
            <div class="border rounded-3 p-3">
                <div class="row pb-3">
                    <div class="col-sm-12">
                        ...
                        <div>
                            <label class="form-label fw-bold pb-1 mb-2">مناقصه ها</label>
                        </div>
                 
                        <div class="row row-cols-sm-2 row-cols-md-2 gx-3 gx-lg-3 skills">
                            @foreach($actGrpsTenderProjectAdsArray as $chunkArray)
                                <div class="col">
...
<div class="row">
    <div class="col-12 mb-4">
        <label class="form-label fw-bold" for="pr-ads-title">عنوان مناقصه</label>
        <span class="text-danger">*</span>
        <input class="form-control form-control-md" type="text" id="pr-ads-title" placeholder="عنوان مناقصه را وارد کنید" wire:model="adsTitle">
...
<div class="row">
    <div class="col-sm-12 mb-4">
        ...
        <select class="form-select form-select-md" wire:model="auctioneer">
            <option value="" disabled="">انتخاب مناقصه گذار</option>
...
<div class="row">
    <div class="col-12 mb-4">
        <label class="form-label fw-bold" for="auction-number">شماره مناقصه</label>
        <span class="text-danger">*</span>
        <span class="fw-bold">(این فیلد در صورتی که مناقصه گذار شخص حقیقی باشد اختیاری است)</span>
        <input class="form-control form-control-md" type="number" id="auction-number" placeholder="شماره مناقصه را به عدد وارد کنید" wire:model="auctionNumber">
...
@foreach ($licenseInputs as $licenseKey => $licenseValue)
    <div class="row">
        <div class="col-sm-10">
            <label class="form-label fw-bold" for="pr-title">مدارک مناقصه را بارگذاری کنید 
            </label>
            <span class="text-danger">*</span>
            ...
            <div class="mb-2">
                <label class="form-label fw-bold" for="pr-description">
                    تصویر مدرک مناقصه را بارگذاری نمایید
                    <span class="text-danger">*</span>
                </label>
...
<div class="row">
    <div class="col-12">
        <label class="form-label fw-bold" for="auction-exp-date">تاریخ اعتبار مناقصه</label>
        <span class="fw-bold">(اختیاری)</span>
    </div>
    <div class="col-6 mb-4">
        <div class="input-group">
            <input data-jdp="" data-jdp-min-date="today" class="form-control form-control-md" id="auction-exp-date-start" placeholder="تاریخ شروع اعتبار مناقصه را انتخاب نمایید" wire:model="auctionExpDateStart">
            <i class="fi-calendar text-muted position-absolute top-50 end-0 translate-middle-y me-3"></i>
        </div>
    </div>
    <div class="col-6 mb-4">
        <div class="input-group">
            <input data-jdp="" data-jdp-min-date="today" class="form-control form-control-md" id="auction-exp-date-end" placeholder="تاریخ پایان اعتبار مناقصه را انتخاب نمایید" wire:model="auctionExpDateEnd">
            <i class="fi-calendar text-muted position-absolute top-50 end-0 translate-middle-y me-3"></i>
        </div>
    </div>
</div>  
