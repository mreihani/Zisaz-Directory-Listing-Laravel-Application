<div class="{{$section == "custom_page" ? '' : 'd-none'}}">   
    <div class="row">
        <div class="col-sm-12 mb-4">
            <label class="form-label" for="pr-country">
                لطفا نوع صفحه اختصاصی خود را تعیین نمایید
                <span class="text-danger">*</span>
            </label>
            <select class="form-select form-select-md" wire:model="customWebPage" wire:change="changeCustomPage($event.target.value)">
                <option value="" disabled="">انتخاب نوع صفحه اختصاصی</option>
                <option value="1">
                    سایت برای شرکت می خواهم
                </option>
                <option value="2">
                    سایت برای فروشگاه می خواهم
                </option>
                <option value="3">
                    سایت برای انبوه سازی می خواهم 
                </option>
                <option value="4">
                    سایت برای معرفی و برندسازی  پروژه می خواهم 
                </option>
                <option value="5">
                    سایت برای دفتر طراحی و مهندسی می خواهم 
                </option>
                <option value="6">
                    سایت برای فعالیت مهندسی خودم می خواهم
                </option>
                <option value="7">
                    سایت برای آزمایشگاه می خواهم 
                </option>
                <option value="8">
                    سایت برای کارخانه می خواهم
                </option>
                <option value="9">
                    سایت برای رزومه شخصی می خواهم
                </option>
            </select>
        </div>
    </div>
