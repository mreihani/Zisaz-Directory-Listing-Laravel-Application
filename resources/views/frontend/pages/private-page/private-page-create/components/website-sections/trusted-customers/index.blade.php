    ...
    <form wire:submit.prevent="save" novalidate>
        <div class="bg-light rounded-3 p-4 p-md-5 mb-3">
            ...
            <div class="alert alert-accent" role="alert">
                <ul class="mb-0">
                    <li>
                        در این بخش می توانید مشتریان مورد اعتماد خود را به کاربران معرفی نمایید.
                    </li>
                    <li>
           ...
           <h2 class="h5 font-vazir mb-4 mt-3">
                ...
                اطلاعات مشتریان مورد اعتماد خود
            </h2>
            ...
            <div class="row">
                <div class="col-md-12 mb-4">
                    ...
                    <textarea {{ $isHidden == true ? 'disabled' : '' }} class="form-control form-control-md" type="text" id="pr-business-header-description" placeholder="توضیحات مرتبط با مشتریان و همکاران مورد اعتماد خود را وارد نمایید" wire:model="headerDescription"></textarea>
