...
<html lang="fa">
    ...
    <body>
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarNine">
                                <ul class="navbar-nav me-auto">
                                    <li class="nav-item"> <a class="page-scroll active" href="#hero-area">خانه</a> </li>
                                    <li class="nav-item"> <a class="page-scroll" href="#services">سرویس‌ها</a> </li>
                                    <li class="nav-item"> <a class="page-scroll" href="#portfolio">نمونه کارها</a> </li>
                                    <li class="nav-item"> <a class="page-scroll" href="#pricing">تعرفه‌ها</a> </li>
                                    <li class="nav-item"> <a class="page-scroll" href="#team">تیم‌ما</a> </li>
                                    <li class="nav-item"> <a class="page-scroll" href="#contact">تماس باما</a> </li>
                                </ul>
                            </div>
                ...
                <div class="row testimonial-slider is-rtl">
                    <div class="col-lg-6 col-12">
                        <div class="single-testimonial">
                            ...
                            <div class="inner-content">
                                <div class="qote-icon"> <i class="lni lni-quotation"></i> </div>
                                <p class="text">
                                ...
                                <div class="author">
                                    <div class="image"> <img src="{{asset('assets/frontend/img/jaban/private-site-images/testimonial/author-1.jpg')}}" alt="Author" /> </div>
                                    <h4 class="name">
                                        مشرف غنی
                                        <span class="deg">طراح وب سایت</span>
                                    </h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="single-testimonial">
                            ...
                            <div class="inner-content">
                                ...
                                <div class="author">
                                    <div class="image"> <img src="{{asset('assets/frontend/img/jaban/private-site-images/testimonial/author-2.jpg')}}" alt="Author" /> </div>
                                    <h4 class="name">
                                        دیوید وارنر
                                        <span class="deg">توسعه دهنده وب</span>
                                    </h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="single-testimonial">
                            ...
                            <div class="inner-content">
                                ...
                                <div class="author">
                                    <div class="image"> <img src="{{asset('assets/frontend/img/jaban/private-site-images/testimonial/author-3.jpg')}}" alt="Author" /> </div>
                                    <h4 class="name">
                                        جیم گلاریو
                                        <span class="deg">طراح گرافیک</span>
                                    </h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="single-testimonial">
                            ...
                            <div class="inner-content">
                                ...
                                <div class="author">
                                    <div class="image"> <img src="{{asset('assets/frontend/img/jaban/private-site-images/testimonial/author-4.jpg')}}" alt="Author" /> </div>
                                    <h4 class="name">
                                        دیوید وارنر
                                        <span class="deg">توسعه دهنده وب</span>
                                    </h4>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="single-testimonial">
                            ...
                            <div class="inner-content">
                                ...
                                <div class="author">
                                    <div class="image"> <img src="{{asset('assets/frontend/img/jaban/private-site-images/testimonial/author-5.jpg')}}" alt="Author" /> </div>
                                    <h4 class="name">
                                        نهیر رحمان
                                        <span class="deg">طراح رابط کاربری</span>
                                    </h4>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-12">
                        <div class="clients-logos">
                            <div class="single-image"> <img src="{{asset('assets/frontend/img/jaban/private-site-images/client-logo/graygrids.svg')}}" alt="لوگو برند" /> </div>
                            <div class="single-image"> <img src="{{asset('assets/frontend/img/jaban/private-site-images/client-logo/uideck.svg')}}" alt="لوگو برند" /> </div>
                            <div class="single-image"> <img src="{{asset('assets/frontend/img/jaban/private-site-images/client-logo/ayroui.svg')}}" alt="لوگو برند" /> </div>
                            <div class="single-image"> <img src="{{asset('assets/frontend/img/jaban/private-site-images/client-logo/lineicons.svg')}}" alt="لوگو برند" /> </div>
                            <div class="single-image"> <img src="{{asset('assets/frontend/img/jaban/private-site-images/client-logo/tailwindtemplates.svg')}}" alt="لوگو برند" /> </div>
                            <div class="single-image"> <img src="{{asset('assets/frontend/img/jaban/private-site-images/client-logo/ecomhtml.svg')}}" alt="لوگو برند" /> </div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="contact" class="contact-section is-rtl">
            <div class="container">
                <div class="row">
                    <div class="col-xl-4">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 col-xl-12">
                                    <div class="contact-item">
                                        ...
                                        <div class="contact-content">
                                            ...
                                            <p>0123456789</p>
                                            <p>
                                                <a class="text-dark" href="mailto:info@yoursite.com">info@yoursite.com</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-xl-12">
                                    <div class="contact-item">
                                        ...
                                        <div class="contact-content">
                                            <h4>آدرس</h4>
                                            <p>خیابان نادری ، خیابان یاس ، نبش فروشگاه ارغوان</p>
                                            <p>ایران</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-8">
                        <div class="contact-form-wrapper">
                            ...
                            <form action="#" class="contact-form">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="text" name="phone" id="phone" placeholder="تلفن" required />
                                    </div>
                                    <div class="col-md-6">
                                        <input type="text" name="subject" id="email" placeholder="موضوع" required />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <textarea name="message" id="message" placeholder="پیام خود را بنویسید" rows="5"></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
