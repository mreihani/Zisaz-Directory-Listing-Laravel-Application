<div class="col-lg-8 col-md-7 mb-5">
    ...
    @if(count($projects))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <span class="fw-bold">توجه: </span>پروژه شما به دلایلی توسط مدیر سامانه رد شده است. برای کسب اطلاع از علت رد شدن آن می توانید بر روی ویرایش پروژه کلیک کنید. پس از ورود به صفحه ویرایش در بالای صفحه علت رد شدن قابل مشاهده خواهد بود.
            ...
            <div class="card card-hover card-horizontal border-0 shadow-sm mb-4" >
                <a class="card-img-top" href="{{route('project', $projectItem->slug)}}" style="background-image: url('{{asset($projectItem->projectImages->first()->image_sm)}}');">
                    <div class="position-absolute start-0 top-0 pt-3 ps-3">
                        <span class="d-table badge bg-dangder">
                            رد شده
                        </span>
                    </div>
                </a>
