<div class="col-lg-8 col-md-7 mb-5">
    ...
    <ul class="nav nav-tabs border-bottom mb-4" role="tablist">
        <li class="nav-item mb-3">
            <a class="nav-link" href="{{route('user.dashboard.saved-ads.index')}}" role="tab" aria-selected="true">
        ...
        <li class="nav-item mb-3">
            <a class="nav-link active" href="{{route('user.dashboard.saved-ads.index', ['type', 'trashed'])}}" role="tab" aria-selected="false">
                ...
                <div class="card-body position-relative pb-3 d-flex flex-column justify-content-between">
                    ...
                    <div class="dropdown position-absolute zindex-5 top-0 end-0 mt-3 me-3">
                        ...
                        <ul class="dropdown-menu my-1" aria-labelledby="contextMenu1">
                            <li>
                                <a class="dropdown-item" href="{{route('user.activity.restore', $adItem->id)}}" onclick="if(confirm('آیا برای بازگردانی این آیتم اطمینان دارید؟')){return true}">
