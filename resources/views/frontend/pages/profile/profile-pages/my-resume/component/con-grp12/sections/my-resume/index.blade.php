        ...
        <div class="col-lg-11 col-xl-10">
            <form wire:submit.prevent="save" class="needs-validation" novalidate>
                ...
                <div class="bg-light rounded-3 p-4 p-md-5 mb-3">
                    <h2 class="h5 font-vazir mb-4"><i class="fi-briefcase text-primary fs-5 mt-n1 me-2 pe-1"></i>آزمایشگاه</h2>
                    <div class="mb-4">
                        ...
                        @endif 
                        <textarea wire:model="workExperience" class="form-control" rows="5" id="pr-description" placeholder="لطفا در باره سابقه آزمایشکاه و تست های که انجام می دهید بنویسید"></textarea>
                    </div>
