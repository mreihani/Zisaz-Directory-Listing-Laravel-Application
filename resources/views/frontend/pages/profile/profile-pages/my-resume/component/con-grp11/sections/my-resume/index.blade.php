            ...
            <form wire:submit.prevent="save" class="needs-validation" novalidate>
                ...
                <div class="bg-light rounded-3 p-4 p-md-5 mb-3">
                    ...
                    <div class="mb-4">
                        ...
                        @endif 
                        <textarea wire:model="workExperience" class="form-control" rows="5" id="pr-description" placeholder="لطفا درباره سابقه آزمایشگاه و تست های که انجام می دهید بنویسید"></textarea>
                    </div>
