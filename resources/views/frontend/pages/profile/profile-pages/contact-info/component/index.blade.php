            ...
            <div class="col-lg-9">
                <div class="border rounded-3 p-3">
                    ...
                    <div class="border-bottom pb-3 mb-3">
                        ...
                        <div>
                            <input class="form-control mt-3" type="text" wire:model="landline_telephone" placeholder="شماره ثابت خود را با پیش شماره استان وارد نمایید">
                        </div>
                        @if($errors->has('landline_telephone'))
                            <span class="text-danger">{{ $errors->first('landline_telephone') }}</span>
                        @endif 
                    </div>
