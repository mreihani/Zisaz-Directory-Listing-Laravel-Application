<div>
    <!-- Categories-->
    <section class="position-relative bg-white rounded-xxl-4 pt-md-3 zindex-5 category-jobs" style="margin-top: -30px;">
        <div class="container pt-5 pb-2 mb-4 mb-md-5">
            <h2 class="h4 pb-2 pb-sm-3 font-vazir">دسته بندی های استخدام</h2>
            <div class="d-flex flex-wrap flex-column flex-sm-row"><a class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 bg-secondary rounded-pill py-2 ps-2 pe-4 mb-2 mb-sm-3 me-sm-3 me-xxl-4" href="job-board-catalog.html">
                ...
                <h3 class="icon-box-title fs-base pe-1 ps-2 mb-0">حسابدار</h3></a><a class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 bg-secondary rounded-pill py-2 ps-2 pe-4 mb-2 mb-sm-3 me-sm-3 me-xxl-4" href="job-board-catalog.html">
                <div class="icon-box-media bg-light text-primary rounded-circle me-2"><i class="fi-pie-chart"></i></div>
                <h3 class="icon-box-title fs-base pe-1 ps-2 mb-0">برنامه نویس</h3></a><a class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 bg-secondary rounded-pill py-2 ps-2 pe-4 mb-2 mb-sm-3 me-sm-3 me-xxl-4" href="job-board-catalog.html">
                <div class="icon-box-media bg-light text-primary rounded-circle me-2"><i class="fi-meds"></i></div>
                <h3 class="icon-box-title fs-base pe-1 ps-2 mb-0">داروساز</h3></a><a class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 bg-secondary rounded-pill py-2 ps-2 pe-4 mb-2 mb-sm-3 me-sm-3 me-xxl-4" href="job-board-catalog.html">
                <div class="icon-box-media bg-light text-primary rounded-circle me-2"><i class="fi-plant"></i></div>
                <h3 class="icon-box-title fs-base pe-1 ps-2 mb-0">فروشنده لباس</h3></a><a class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 bg-secondary rounded-pill py-2 ps-2 pe-4 mb-2 mb-sm-3 me-sm-3 me-xxl-4" href="job-board-catalog.html">
                <div class="icon-box-media bg-light text-primary rounded-circle me-2"><i class="fi-computer"></i></div>
                <h3 class="icon-box-title fs-base pe-1 ps-2 mb-0">بازاریابی</h3></a><a class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 bg-secondary rounded-pill py-2 ps-2 pe-4 mb-2 mb-sm-3 me-sm-3 me-xxl-4" href="job-board-catalog.html">
                <div class="icon-box-media bg-light text-primary rounded-circle me-2"><i class="fi-security"></i></div>
                <h3 class="icon-box-title fs-base pe-1 ps-2 mb-0">تولید محتوا</h3></a>
            <div class="dropdown mb-2 mb-sm-3"><a class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 bg-secondary rounded-pill py-2 ps-2 pe-4" href="job-board-catalog.html" data-bs-toggle="dropdown">
                ...
                <h3 class="icon-box-title fs-base pe-1 ps-2 mb-0">سایر</h3></a>
                <div class="dropdown-menu dropdown-menu-sm-end my-1"><a class="dropdown-item fw-bold" href="job-board-catalog.html"><i class="fi-briefcase fs-base opacity-60 me-2"></i>مدیریت</a><a class="dropdown-item fw-bold" href="job-board-catalog.html"><i class="fi-building fs-base opacity-60 me-2"></i>معمار</a><a class="dropdown-item fw-bold" href="job-board-catalog.html"><i class="fi-car fs-base opacity-60 me-2"></i>راننده</a><a class="dropdown-item fw-bold" href="job-board-catalog.html"><i class="fi-cart fs-base opacity-60 me-2"></i>فروشنده</a><a class="dropdown-item fw-bold" href="job-board-catalog.html"><i class="fi-cash fs-base opacity-60 me-2"></i>نگهبان</a></div>
            </div>
            </div>
        </div>
    </section>
    ...
    <section class="container mb-4 mb-md-5">
        <div class="row">
            ...
            <div class="card h-100">
                <div class="d-sm-flex align-items-center flex-row-reverse">
                <div class="pt-4 ps-sm-4 py-sm-4 p-lg-5 flex-shrink-0"><img class="d-block mx-auto" src="{{asset('assets/frontend/img/pricing/icon-4.svg')}}" width="86" alt="Icon"></div>
                <div class="card-body text-center text-sm-start">
                    <h2 class="h5 mb-2">کشف فرصت‌های شغلی</h2>
                    <p class="mb-sm-4">این سایت با معرفی فرصت‌های شغلی که هیچ جای دیگر نمی‌دیدم، به من کمک کرد تا موقعیت شغلی جدیدم را بهتر انتخاب کنم.</p><a class="fw-bold text-decoration-none py-1" href="job-board-catalog.html">مشاهده همه <i class="fi-chevron-right fs-xs ms-2"></i></a>
                </div>
                </div>
            </div>
            </div>
            ...
            <div class="card h-100">
                <div class="d-sm-flex align-items-center flex-row-reverse">
                <div class="pt-4 ps-sm-4 py-sm-4 p-lg-5 flex-shrink-0"><img class="d-block mx-auto" src="{{asset('assets/frontend/img/pricing/icon-1.svg')}}" width="86" alt="Icon"></div>
                <div class="card-body text-center text-sm-start">
                    <h2 class="h5 mb-2">استخدام های فوری امروز</h2>
                    <p class="mb-sm-4">این سایت با معرفی فرصت‌های شغلی که هیچ جای دیگر نمی‌دیدم، به من کمک کرد تا موقعیت شغلی جدیدم را بهتر انتخاب کنم.</p><a class="fw-bold text-decoration-none py-1" href="job-board-catalog.html">مشاهده همه <i class="fi-chevron-right fs-xs ms-2"></i></a>
                </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="d-sm-flex align-items-center justify-content-between pb-4 mb-sm-2">
                <h2 class="h4 mb-sm-0 font-vazir">استخدام های امروز</h2><a class="btn btn-link fw-normal p-0" href="job-board-catalog.html">مشاهده همه <i class="fi-arrow-long-left ms-2"></i></a>
            </div>
            <!-- Accordion-->
            <div id="accordionJobs">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center"><img class="me-2" src="{{asset('assets/frontend/img/job-board/company/it-pro.png')}}" width="24" alt="IT Pro Logo"><span class="fs-sm text-dark opacity-80 ps-1">فست کلیک</span></div><span class="badge bg-faded-danger rounded-pill fs-sm">فوری</span>
                    </div>
                    <h3 class="h6 card-title pt-1 mb-0">استخدام تکنسین برق (آقا-کرج)</h3>
                </div>
                <div class="collapse" id="jobCollapse1" data-bs-parent="#accordionJobs">
                    <div class="card-body mt-n1 pt-0">
                    <p class="fs-sm">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که <a href='#'>بیشتر بخوانید...</a></p>
                    <div class="d-flex align-items-center justify-content-between"> 
                        <div class="fs-sm"><span class="text-nowrap me-3"><i class="fi-map-pin text-muted me-1"> </i>شیکاگو</span><span class="text-nowrap ms-3"><i class="fi-cash fs-base text-muted me-1"></i>75000 تومان</span></div>
                        <button class="btn btn-icon btn-light btn-xs text-primary shadow-sm rounded-circle" type="button" data-bs-toggle="tooltip" title="نشان کردن"><i class="fi-heart"></i></button>
                    </div>
                    </div>
                </div>
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-2">
                    <div class="d-flex align-items-center"><img class="me-2" src="{{asset('assets/frontend/img/job-board/company/xbox.png')}}" width="24" alt="Xbox Logo"><span class="fs-sm text-dark opacity-80 ps-1">شرکت درسا</span></div><span class="badge bg-faded-accent rounded-pill fs-sm">ویژه</span>
                    </div>
                    <h3 class="h6 card-title pt-1 mb-0">استخدام طراح و گرافیست</h3>
                </div>
                <div class="collapse show" id="jobCollapse2" data-bs-parent="#accordionJobs">
                    <div class="card-body mt-n1 pt-0">
                    <p class="fs-sm">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که <a href='#'>بیشتر بخوانید...</a></p>
                    <div class="d-flex align-items-center justify-content-between"> 
                        <div class="fs-sm"><span class="text-nowrap me-3"><i class="fi-map-pin text-muted me-1"> </i>پاریس</span><span class="text-nowrap ms-3"><i class="fi-cash fs-base text-muted me-1"></i>13000 تومان</span></div>
                        <button class="btn btn-icon btn-light btn-xs text-primary shadow-sm rounded-circle" type="button" data-bs-toggle="tooltip" title="نشان کردن"><i class="fi-heart"></i></button>
                    </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-2">
                    <div class="d-flex align-items-center"><img class="me-2" src="{{asset('assets/frontend/img/job-board/company/xampp.png')}}" width="24" alt="XAMPP Logo"><span class="fs-sm text-dark opacity-80 ps-1">کارگزاری مفید</span></div><span class="badge bg-faded-danger rounded-pill fs-sm">فوری</span>
                    </div>
                    <h3 class="h6 card-title pt-1 mb-0">استخدام کارشناس انبار</h3>
                </div>
                <div class="collapse" id="jobCollapse3" data-bs-parent="#accordionJobs">
                    <div class="card-body mt-n1 pt-0">
                    <p class="fs-sm">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که <a href='#'>بیشتر بخوانید...</a></p>
                    <div class="d-flex align-items-center justify-content-between"> 
                        <div class="fs-sm"><span class="text-nowrap me-3"><i class="fi-map-pin text-muted me-1"> </i>ایتالیا</span><span class="text-nowrap ms-3"><i class="fi-cash fs-base text-muted me-1"></i>65000 تومان</span></div>
                        <button class="btn btn-icon btn-light btn-xs text-primary shadow-sm rounded-circle" type="button" data-bs-toggle="tooltip" title="نشان کردن"><i class="fi-heart"></i></button>
                    </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-2">
                    <div class="d-flex align-items-center"><img class="me-2" src="{{asset('assets/frontend/img/job-board/company/elastic.png')}}" width="24" alt="Elastic Logo"><span class="fs-sm text-dark opacity-80 ps-1">شرکت توسعه پردازان</span></div><span class="badge bg-faded-accent rounded-pill fs-sm">ویژه</span>
                    </div>
                    <h3 class="h6 card-title pt-1 mb-0">استخدام طراح گرافیک</h3>
                </div>
                <div class="collapse" id="jobCollapse4" data-bs-parent="#accordionJobs">
                    <div class="card-body mt-n1 pt-0">
                    <p class="fs-sm">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که <a href='#'>بیشتر بخوانید...</a></p>
                    <div class="d-flex align-items-center justify-content-between"> 
                        <div class="fs-sm"><span class="text-nowrap me-3"><i class="fi-map-pin text-muted me-1"> </i>فرانسه</span><span class="text-nowrap ms-3"><i class="fi-cash fs-base text-muted me-1"></i>80000 تومان</span></div>
                        <button class="btn btn-icon btn-light btn-xs text-primary shadow-sm rounded-circle" type="button" data-bs-toggle="tooltip" title="نشان کردن"><i class="fi-heart"></i></button>
                    </div>
                    </div>
                </div>
            ...
            <div class="col-md-5 text-center text-md-start"><img class="d-block mx-auto mb-4" src="{{asset('assets/frontend/img/job-board/illustrations/post-resume-cta2.svg')}}" width="416" alt="Illustration">
            <h2 class="h3 pt-2 mb-4 font-vazir">یک روزمه حرفه ای برگ برنده شماست.</h2>
            <p class="pb-md-3">یک رزومه عالی در سایت ایجاد کنید و گامی در جهت یافتن شغل رویایی خود بردارید!</p><a class="btn btn-primary btn-lg rounded-pill ms-sm-auto" href="job-board-post-resume-1.html">رزومه ساز<i class="fi-chevron-right fs-sm ms-2"></i></a>
            </div>
        </div>
        </section>
        <!-- Jobs by city-->
        ...
        <div class="d-sm-flex align-items-center justify-content-between pb-4 mb-sm-2">
            <h2 class="h4 mb-sm-0 font-vazir">استخدام براساس شهر</h2><a class="btn btn-link fw-normal p-0" href="job-board-catalog.html">مشاهده همه <i class="fi-arrow-long-left ms-2"></i></a>
        </div>
        <div class="tns-carousel-wrapper tns-controls-outside-xxl tns-nav-outside">
            ...
            <div>
                ...
                <div class="bg-secondary rounded-3 p-4 mb-3"><img class="d-block mx-auto" src="{{asset('assets/frontend/img/job-board/city/new-york.svg')}}" alt="New York"></div>
                <div class="text-center"><a class="nav-link stretched-link p-0" href="job-board-catalog.html">نیویورک</a><span class="fs-sm">328 شغل</span></div>
                </div>
            </div>
            <div>
                <div class="position-relative">
                <div class="bg-secondary rounded-3 p-4 mb-3"><img class="d-block mx-auto" src="{{asset('assets/frontend/img/job-board/city/paris.svg')}}" alt="Paris"></div>
                <div class="text-center"><a class="nav-link stretched-link p-0" href="job-board-catalog.html">پاریس</a><span class="fs-sm">152 شغل</span></div>
                </div>
            </div>
            <div>
                <div class="position-relative">
                <div class="bg-secondary rounded-3 p-4 mb-3"><img class="d-block mx-auto" src="{{asset('assets/frontend/img/job-board/city/london.svg')}}" alt="London"></div>
                <div class="text-center"><a class="nav-link stretched-link p-0" href="job-board-catalog.html">لندن</a><span class="fs-sm">74 شغل</span></div>
                </div>
            </div>
            <div>
                <div class="position-relative">
                <div class="bg-secondary rounded-3 p-4 mb-3"><img class="d-block mx-auto" src="{{asset('assets/frontend/img/job-board/city/bangkok.svg')}}" alt="Bangkok"></div>
                <div class="text-center"><a class="nav-link stretched-link p-0" href="job-board-catalog.html">فرانسه</a><span class="fs-sm">92 شغل</span></div>
                </div>
            </div>
            <div>
                <div class="position-relative">
                <div class="bg-secondary rounded-3 p-4 mb-3"><img class="d-block mx-auto" src="{{asset('assets/frontend/img/job-board/city/barcelona.svg')}}" alt="Barcelona"></div>
                <div class="text-center"><a class="nav-link stretched-link p-0" href="job-board-catalog.html">لوس آنجلس</a><span class="fs-sm">204 شغل</span></div>
                </div>
            </div>
            <div>
                <div class="position-relative">
                <div class="bg-secondary rounded-3 p-4 mb-3"><img class="d-block mx-auto" src="{{asset('assets/frontend/img/job-board/city/dubai.svg')}}" alt="Dubai"></div>
                <div class="text-center"><a class="nav-link stretched-link p-0" href="job-board-catalog.html">استانبول</a><span class="fs-sm">196 شغل</span></div>
                </div>
            </div>
            <div>
                <div class="position-relative">
                <div class="bg-secondary rounded-3 p-4 mb-3"><img class="d-block mx-auto" src="{{asset('assets/frontend/img/job-board/city/kuala-lumpur.svg')}}" alt="Kuala Lumpur"></div>
                <div class="text-center"><a class="nav-link stretched-link p-0" href="job-board-catalog.html">ترکیه</a><span class="fs-xs">143 شغل</span></div>
                </div>
            </div>
            </div>
        </div>
        ...
        <h2 class="h4 text-sm-start mb-sm-4 font-vazir">شرکت های برتر</h2>
        <div class="tns-carousel-wrapper tns-nav-outside tns-nav-outside-flush">
            ...
            <div class="pb-1"><a class="swap-image" href="job-board-employer-single.html"><img class="swap-to" src="{{asset('assets/frontend/img/job-board/company/xampp.png')}}" width="196" alt="Microsoft"><img class="swap-from" src="{{asset('assets/frontend/img/job-board/company/microsoft-g.svg')}}" width="196" alt="Microsoft"></a></div>
            ...
            <div class="pb-1"><a class="swap-image" href="job-board-employer-single.html"><img class="swap-to" src="{{asset('assets/frontend/img/job-board/company/walmart.svg')}}" width="196" alt="Walmart"><img class="swap-from" src="{{asset('assets/frontend/img/job-board/company/walmart-g.svg')}}" width="196" alt="Walmart"></a></div>
