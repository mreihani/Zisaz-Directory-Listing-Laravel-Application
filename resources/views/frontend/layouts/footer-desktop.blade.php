{{-- <footer class="footer bg-secondary pt-5 d-none d-lg-block">
        ...
        <div class="row align-items-center pb-4">
            <div class="col-md-6 col-xl-5">
                ...
                <div class="text-nowrap border-top border-light py-4">
                    <a class="btn btn-icon btn-light-primary btn-xs rounded-circle me-2" href="#">
                    ...
                    <a class="btn btn-icon btn-light-primary btn-xs rounded-circle" href="#">
                ...
                <div class="d-flex align-items-center">
                    <div class="card card-light card-body p-4 p-xl-5 my-2 my-md-0" style="max-width: 526px;">
                        <div style="max-width: 380px;">
                            <h3 class="h5 text-dark">دانلود اپلیکیشن</h3>
                            <p class="fs-sm text-dark opacity-70 mb-2 mb-lg-3">همه چیزهایی را که برای ثبت و جستجوی یک قرصت شغلی نیاز دارید در اپ جدید ما پیدا کنید!</p>
                            <div class="d-flex flex-column flex-sm-row">
                                <a class="btn-market me-sm-3 mt-3" href="#" role="button">
                    ...
                    <img class="d-none d-xl-block me-n4" src="{{asset('assets/frontend/img/job-board/footer-mobile.svg')}}" width="116" alt="Mobile app">
                </div>
            </div>
        </div>
        <!-- Copyright-->
        <p class="fs-sm text-center text-sm-end mb-4">
            <span class="text-dark opacity-50">&copy; تمام حقوق این سایت محفوظ است . ارائه شده در سایت </span>
            <a class="nav-link fw-bold" href="https://createx.studio/" target="_blank" rel="noopener"></a>
        </p>
    </div>
</footer> --}}
    ...
    <div class="container pb-2">
        <div class="row align-items-center pb-4">
            ...
            <div class="col-md-2 mb-4">
                <div class="row">
                    <div class="col">
                        <a class="navbar-brand ms-0 ms-xl-4" href="https://logo.samandehi.ir/logo.aspx?id=368127&p=qftiwlbqaqgwnbpdodrfyndt">
                            <img class="d-block" src="{{asset('assets/frontend/img/jaban/enamad/samandehi.png')}}" width="150" alt="ساماندهی">
                        </a>
                    </div>
                    <div class="col">
                        <a class="navbar-brand ms-0 ms-xl-4" href="">
                            <img class="d-block" src="{{asset('assets/frontend/img/jaban/enamad/majaz.png')}}" width="150" alt="مجازی">
                        </a>
                    </div>
                    <div class="col">
                        <a class="navbar-brand ms-0 ms-xl-4" href="https://trustseal.enamad.ir/?id=486501&Code=BkoMLWYkedGcDvTZI6RK8CD6nvUsCSTI">
                            <img class="d-block" src="{{asset('assets/frontend/img/jaban/enamad/enamad.png')}}" width="150" alt="ای نماد">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="">
            ...
            <span class="text-dark opacity-50 ms-4">
                تمامی حقوق مادی و معنوی این پلتفرم (وبسایت و اپلیکیشن) متعلق به شرکت سامانه مهندسی و املاک جابان (زی ساز) است.
            </span>
        </div>
    </div>
</footer>