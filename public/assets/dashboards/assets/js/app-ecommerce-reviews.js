    ...
    var dt_review = dt_customer_review.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              '<span class="fw-medium text-nowrap lh-80p">' +
              $product +
              '</span></a>' +
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $review =
              ...
              'عنوان نظر کاربر نسبت به ما' +
              '</p>' +
              '<small class="text-break pe-3 lh-80p">' +
              'در اینجا توضیحات و شرح نظر کاربر قرار داده می شود تا نسبت به بازخورد ایشان مطلع شوید' +
              '</small>' +
              '</div>';
...

        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" class="dropdown-item">کپی</a>' +
      ...
      initComplete: function () {
        ...
        this.api()
          ...
          .every(function () {
            var column = this;
            var select = $('<select id="Review" class="form-select"><option value=""> همه </option></select>')
