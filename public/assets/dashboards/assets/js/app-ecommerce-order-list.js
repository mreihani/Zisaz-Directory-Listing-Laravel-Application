      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return '<span class="text-nowrap"><bdi>' + full.date + ', ' + timeX + '</bdi></span>';
          }
        },
        {
          // Customers
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              $method +
              '"class="me-2" width="16">' +
              '<span><bdo><i class="ti ti-dots me-1 mt-n1"></i>' +
              $method_number +
              '</bdo></span>' +
              '</div>'
            );
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="app-ecommerce-order-details.html" class="dropdown-item">مشاهده</a>' +
