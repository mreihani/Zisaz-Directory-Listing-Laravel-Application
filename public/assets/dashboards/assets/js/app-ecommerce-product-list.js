  ...
  if (dt_product_table.length) {
    var dt_products = dt_product_table.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $category_key = categoryObj[full['category']].key;
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:0;" class="dropdown-item">مشاهده</a>' +
              '<a href="javascript:0;" class="dropdown-item">مسدود</a>' +
              '</div>' +
              '</div>'
            );
          }
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">افزودن محصول</span>',
      ...
      responsive: {
        details: {
          display: $.fn.dataTable.Responsive.display.modal({
            header: function (row) {
              var data = row.data();
              return 'جزئیات ' + data['product_name'];
            }
          }),
          type: 'column',
