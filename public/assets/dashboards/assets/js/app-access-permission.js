        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var $assignedTo = full['assigned_to'],
              $output = '';
            var roleBadgeObj = {
              Admin: '<a href="' + userList + '"><span class="badge bg-label-primary m-1">مدیر</span></a>',
              Manager: '<a href="' + userList + '"><span class="badge bg-label-warning m-1">نویسنده</span></a>',
              Users: '<a href="' + userList + '"><span class="badge bg-label-success m-1">گرافیست</span></a>',
              Support: '<a href="' + userList + '"><span class="badge bg-label-info m-1">پشتیبان</span></a>',
              Restricted:
                '<a href="' + userList + '"><span class="badge bg-label-danger m-1">حسابدار</span></a>'
            };
