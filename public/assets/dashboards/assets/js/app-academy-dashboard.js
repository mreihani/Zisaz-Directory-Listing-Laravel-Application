...
(function () {
  ...
  if (dt_academy_course.length) {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              '</span>' +
              '<div>' +
              '<a class="text-body text-truncate fw-semibold mb-1 text-wrap" href="app-academy-course-details.html">' +
              $course +
              '</a>' +
              '<div class="d-flex align-items-center">' +
    ...
    $('div.head-label').html('<h5 class="card-title mb-0 text-nowrap">دوره‌های شما</h5>');
  }
