  ...
  if (dtUserTable.length) {
    var dtUser = dtUserTable.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" class="dropdown-item">ویرایش</a>' +
      ...
      dom:
        ...
        '>',
      language: {
        url: assetsPath + '/vendor/libs/datatables-bs5/i18n/fa.json',
      ...
      initComplete: function () {
        ...
        this.api()
          ...
          .every(function () {
            ...
            select.append('<option value="Admin" class="text-capitalize">ادمین</option>');
            select.append('<option value="Author" class="text-capitalize">نویسنده</option>');
            select.append('<option value="Editor" class="text-capitalize">ویرایشگر</option>');
            select.append('<option value="Maintainer" class="text-capitalize">مدیرعامل</option>');
            select.append('<option value="Subscriber" class="text-capitalize">دنبال کننده</option>');
