...
$(function () {
  ...
  if (dt_category_list_table.length) {
    var dt_category = dt_category_list_table.DataTable({
      ...
      buttons: [
        {
          text: '<i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">افزودن دسته</span>',
  ...
  const fv = FormValidation.formValidation(eCommerceCategoryListForm, {
    fields: {
      categoryTitle: {
        validators: {
          notEmpty: {
            message: 'عنوان دسته را وارد کنید'
          }
        }
      },
      slug: {
        validators: {
          notEmpty: {
            message: 'توضیحات مختصر را وارد کنید'
          }
        }
      }
    },
