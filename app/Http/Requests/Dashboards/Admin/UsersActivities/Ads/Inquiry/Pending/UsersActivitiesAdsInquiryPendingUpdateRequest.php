...
namespace App\Http\Requests\Dashboards\Admin\UsersActivities\Ads\Inquiry\Pending;

use Illuminate\Http\Request;
use Illuminate\Foundation\Http\FormRequest;


class UsersActivitiesAdsInquiryPendingUpdateRequest extends FormRequest
{
    /**
