...
namespace App\Http\Requests\Dashboards\Admin\UsersActivities\Ads\Selling\Pending;

use Illuminate\Http\Request;
use Illuminate\Foundation\Http\FormRequest;


class UsersActivitiesAdsSellingPendingUpdateRequest extends FormRequest
{
    /**
