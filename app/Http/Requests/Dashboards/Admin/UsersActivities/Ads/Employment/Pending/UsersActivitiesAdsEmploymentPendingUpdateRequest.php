...
namespace App\Http\Requests\Dashboards\Admin\UsersActivities\Ads\Employment\Pending;

use Illuminate\Http\Request;
use Illuminate\Foundation\Http\FormRequest;


class UsersActivitiesAdsEmploymentPendingUpdateRequest extends FormRequest
{
    /**
