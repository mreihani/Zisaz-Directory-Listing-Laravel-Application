...
namespace App\Http\Requests\Dashboards\Admin\UsersActivities\Ads\Investment\Pending;

use Illuminate\Http\Request;
use Illuminate\Foundation\Http\FormRequest;


class UsersActivitiesAdsInvestmentPendingUpdateRequest extends FormRequest
{
    /**
