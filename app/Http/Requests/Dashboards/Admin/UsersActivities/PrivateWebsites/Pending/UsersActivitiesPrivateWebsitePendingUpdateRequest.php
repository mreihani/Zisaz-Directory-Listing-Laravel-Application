...
namespace App\Http\Requests\Dashboards\Admin\UsersActivities\PrivateWebsites\Pending;

use Illuminate\Http\Request;
use Illuminate\Foundation\Http\FormRequest;


class UsersActivitiesPrivateWebsitePendingUpdateRequest extends FormRequest
{
    /**
