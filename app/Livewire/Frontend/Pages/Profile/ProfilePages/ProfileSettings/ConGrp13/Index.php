...
namespace App\Livewire\Frontend\Pages\Profile\ProfilePages\ProfileSettings\ConGrp13;
...
class Index extends Component
{
    ...
    public function mount() {
        ...
        $this->shopActGrpsArray = ShopActCat::find(4)->shopActivityGroup->chunk($this->calculateChunkNumber())->toArray();
    }
    ...
    private function calculateChunkNumber() {
        ...
        $totalCount = ShopActCat::find(4)->shopActivityGroup->count();
    ...
    {
        return view('frontend.pages.profile.profile-pages.profile-settings.component.con-grp13.index');
    }
}
