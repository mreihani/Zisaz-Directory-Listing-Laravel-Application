...
namespace App\Livewire\Frontend\Pages\Profile\ProfilePages\MyResume\ConGrp1\Sections\WorkExperience;
...
class Index extends Component
{
    ...
    {
        return view('frontend.pages.profile.profile-pages.my-resume.component.con-grp' . auth()->user()->userGroupType->groupable->id . '.sections.work-experience.index');
    }
}
