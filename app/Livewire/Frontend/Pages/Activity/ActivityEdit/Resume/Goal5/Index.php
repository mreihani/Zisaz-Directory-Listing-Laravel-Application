...
namespace App\Livewire\Frontend\Pages\Activity\ActivityEdit\Resume\Goal5;
...
class Index extends Component
{
    ...
    protected function rules() {
        return [
            'selectedProvinceIdValidation' => new SelectedProvinceValidationRule(5, $this->selectedProvinceId, "", ""),
            'selectedCityIdValidation' => new SelectedCityValidationRule(5, $this->selectedCityId, "", ""),
            'companyTitle' => 'required',
            'companyRegNum' => 'required',
            'address' => 'required',
            'actGrpsId' => new SelectedActGrpsIdValidationRule(5, ""),
        ];
    }

    protected $messages = [
        'companyTitle.required' => 'لطفا نام آزمایشگاه را وارد نمایید!',
        'companyRegNum.required' => 'لطفا شماره مجوز آزمایشگاه را وارد نمایید!',
        'address.required' => 'لطفا آدرس آزمایشگاه را وارد نمایید!',
    ];
    ...
    {
        return view('frontend.pages.activity.activity-edit.resume.goal-5.index');
    }
}
