...
namespace App\Livewire\Frontend\Pages\Activity\ActivityEdit\Resume\Goal1;
...
class Index extends Component
{
    ...
    protected function rules() {
        return [
            'selectedProvinceIdValidation' => new SelectedProvinceValidationRule(1, $this->selectedProvinceId, "", ""),
            'selectedCityIdValidation' => new SelectedCityValidationRule(1, $this->selectedCityId, "", ""),
            'jobTitle' => 'required',
            'actGrpsId' => new SelectedActGrpsIdValidationRule(1, ""),
        ];
    }

    protected $messages = [
        'jobTitle.required' => 'لطفا عنوان شغل خود را وارد نمایید!',
    ];
    ...
    private function getInitialValues() {
        ...
        $this->jobTitle = $this->resume->item_title;
    ...
    {
        return view('frontend.pages.activity.activity-edit.resume.goal-1.index');
    }
}
