...
namespace App\Livewire\Frontend\Pages\Activity\ActivityEdit\Resume\Goal6;
...
class Index extends Component
{
    ...
    protected function rules() {
        return [
            'selectedProvinceIdValidation' => new SelectedProvinceValidationRule(6, $this->selectedProvinceId, "", ""),
            'selectedCityIdValidation' => new SelectedCityValidationRule(6, $this->selectedCityId, "", ""),
            'companyTitle' => 'required',
            'address' => 'required',
            'actGrpsId' => new SelectedActGrpsIdValidationRule(6, ""),
        ];
    }
    ...
    private function getInitialValues() {
        ...
        $this->factoryProjectDescription = $this->resume->project_description;
    ...
    {
        return view('frontend.pages.activity.activity-edit.resume.goal-6.index');
    }
}
