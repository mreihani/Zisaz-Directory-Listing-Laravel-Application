...
namespace App\Livewire\Frontend\Pages\Activity\ActivityEdit\Resume\Goal4;
...
class Index extends Component
{
    ...
    protected function rules() {
        return [
            'selectedProvinceIdValidation' => new SelectedProvinceValidationRule(4, $this->selectedProvinceId, "", ""),
            'selectedCityIdValidation' => new SelectedCityValidationRule(4, $this->selectedCityId, "", ""),
            'companyTitle' => 'required',
            'address' => 'required',
            'actGrpsId' => new SelectedActGrpsIdValidationRule(4, ""),
        ];
    }

    protected $messages = [
        'companyTitle.required' => 'لطفا نام دفتر طراحی مهندسی را وارد نمایید!',
        'address.required' => 'لطفا آدرس دفتر طراحی مهندسی را وارد نمایید!',
    ];
    ...
    {
        return view('frontend.pages.activity.activity-edit.resume.goal-4.index');
    }
}
