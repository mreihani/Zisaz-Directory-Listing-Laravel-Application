...
namespace App\Livewire\Frontend\Pages\Activity\ActivityEdit\AdsRegistration\Bid\Tender\TenderBuy;
...
class Index extends Component
{
    ...
    private function getInitialValues() {
        ...
        foreach (ActCat::find(21)->activityGroup->pluck('id')->toArray() as $checkedItemValue) {
    ...
    {
        return view('frontend.pages.activity.activity-edit.ads_registration.bid.tender.tender-buy');
    }
}
