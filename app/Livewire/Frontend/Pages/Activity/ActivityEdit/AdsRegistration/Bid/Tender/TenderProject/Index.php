...
namespace App\Livewire\Frontend\Pages\Activity\ActivityEdit\AdsRegistration\Bid\Tender\TenderProject;
...
class Index extends Component
{
    ...
    protected function rules() {
        return [
            ...
            'auctioneerValidation' => new AuctioneerValidationRule($this->auctioneer, "bid", "tender", ""),
    ...
    private function getInitialValues() {
        ...
        foreach (ActCat::find(22)->activityGroup->pluck('id')->toArray() as $checkedItemValue) {
    ...
    {
        return view('frontend.pages.activity.activity-edit.ads_registration.bid.tender.tender-project');
    }
}
