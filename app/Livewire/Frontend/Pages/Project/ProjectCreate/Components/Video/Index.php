...
namespace App\Livewire\Frontend\Pages\Project\ProjectCreate\Components\Video;
...
class Index extends Component
{
    ...
    {
        return view('frontend.pages.project.project-create.components.project-sections.video.index');
    } 
}
