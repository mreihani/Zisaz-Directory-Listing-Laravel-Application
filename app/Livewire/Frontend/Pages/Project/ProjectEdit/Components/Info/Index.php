...
namespace App\Livewire\Frontend\Pages\Project\ProjectEdit\Components\Info;
...
class Index extends Component
{
    ...
    {
        return view('frontend.pages.project.project-edit.components.project-sections.info.index');
    } 
}
